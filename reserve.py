...
class Inquiry(QDialog):
    ...
    def initUI(self):
        ...
        delbtn.setStyleSheet('background-image: url(image/삭제.png);')
        delbtn.setFixedSize(97,45)
        delbtn.clicked.connect(self.Delete)
        backbtn=QPushButton("",self)
        backbtn.setStyleSheet('background-image: url(image/이전.png);')
        ...
        backgroundlmage = QImage('image/init.png')
        palette = QPalette()
    ...
    def Delete(self):
        try:
            ...
            if date==now_date:
                ...
                sign=0
            if sign==1:
                mbox.Messagebox(self,"예약 취소가 불가합니다.")
            else:
                self.dialog=Check(self.id,date,time,game)
        except:
            mbox.Messagebox(self,"빈 셀을 선택했습니다.")
    def ROW(self):
...
class Detail(QDialog):
    ...
    def initUI(self):
        ...
        back.setStyleSheet('background-image : url(image/BACK.png);')
        layout=QVBoxLayout()
        layout.addWidget(self.table)
    ...
    def cli(self):
        if self.table.currentItem()==None:
            if self.overlap()==True:
                mbox.Messagebox(self,"이미 예약 되었습니다.")
            else:
                if self.Sametime()==True:
                    mbox.Messagebox(self,"같은 시간대에 다른 종목이 예약되어 있습니다.")
                else:
                    ...
                    if signal==0:
                        ...
                        db.Database(sql,0)
                        text = "예약되었습니다."
                    mbox.Messagebox(self,text)
        else:
            mbox.Messagebox(self,"이미 예약자가 존재합니다.")
    def back(self):
        self.setVisible(False)
    ...
    def plan(self):
        ...
        if int(temp[0])<cur.year:
            ...
            if cur.month==12 and int(temp[1])==1 and int(temp[0])-cur.year==1:
                ...
                signal=0
        if signal==0:
            mbox.Messagebox(self,"예약할 수 없는 날짜 입니다.")
        else:
            self.setVisible(False)
...
class reserve_d(QDialog):
    ...
    def initUI(self):
        ...
        btn1.setStyleSheet('background-image:url(image/스포츠파크.png);')
        ...
        btn2.setStyleSheet('background-image:url(image/종합경기장.png);')
        ...
        btn3.setStyleSheet('background-image:url(image/모덕구장.png);')
        ...
        btn4.setStyleSheet('background-image:url(image/와룡지구.png);')
        ...
        if self.type=='농구':
            btn3.setStyleSheet('background-image:url(image/모덕사용불가.png);')
            label3.setText('모덕체육구장(X)')
            label3.setGeometry(82, 465, 130, 20)
            btn4.setStyleSheet('background-image:url(image/와룡사용불가.png);')
            label4.setText('와룡지구체육시설(X)')
            label4.setGeometry(300,465,150,20)
            btn3.setEnabled(False)
            btn4.setEnabled(False)
        elif self.type=='족구':
            btn1.setStyleSheet('background-image:url(image/파크사용불가.png);')
            label1.setText('스포츠파크(X)')
            label1.setGeometry(87, 255, 120, 20)
            btn2.setStyleSheet('background-image:url(image/종합사용불가.png);')
        ...
        back.clicked.connect(self.back)
        back.setStyleSheet('''
                       QPushButton{background-image: url(image/뒤로가기.png); border:0px;} 
                       QPushButton:hover{background-image: url(image/뒤로가기2.png); border:0px;}
                       ''')
        lmage = QImage('image/white.png')
        palette = QPalette()
...
class Check(QDialog):
    ...
    def initUI(self):
        ...
        btn.setStyleSheet('background-image: url(image/취소.png);')
        backgroundlmage = QImage('image/취소확인.png')
        palette = QPalette()
        palette.setBrush(10, QBrush(backgroundlmage))
        self.setWindowIcon(QIcon('image/아이콘.png'))
    ...
    def boan(self):
        ...
        if b==self.tet.text():
            ...
            mbox.Messagebox(self,"비밀번호가 틀렸습니다.")
...
class reserve(QDialog):
    ...
    def initUI(self):
        ...
        btn1.setStyleSheet('''
              QPushButton{background-image: url(image/soccer.png); border:0px;} 
              QPushButton:hover{background-image: url(image/soccer2.png); border:0px;}
              ''')
        btn2 = QPushButton('', self)
        btn2.setGeometry(128, 130, 120, 40)
        btn2.clicked.connect(lambda:self.Image('풋살'))
        btn2.setStyleSheet('''
               QPushButton{background-image: url(image/foot.png); border:0px;} 
               QPushButton:hover{background-image: url(image/foot2.png); border:0px;}
               ''')
        btn3 = QPushButton('', self)
        btn3.setGeometry(250, 130, 120, 40)
        btn3.clicked.connect(lambda:self.Image('족구'))
        btn3.setStyleSheet('''
               QPushButton{background-image: url(image/gu.png); border:0px;} 
               QPushButton:hover{background-image: url(image/gu2.png); border:0px;}
               ''')
        btn4 = QPushButton('', self)
        btn4.setGeometry(372, 130, 120, 40)
        btn4.clicked.connect(lambda:self.Image('농구'))
        btn4.setStyleSheet('''
               QPushButton{background-image: url(image/bask.png); border:0px;} 
               QPushButton:hover{background-image: url(image/bask2.png); border:0px;}
               ''')
        btnr=QPushButton('',self)
        btnr.setStyleSheet('''
                       QPushButton{background-image: url(image/예약조회.png); border:0px;} 
                       QPushButton:hover{background-image: url(image/예약조회2.png); border:0px;}
                       ''')
        ...
        self.btselect.setStyleSheet('background-image : url(image/축구.png);')
    ...
    def Image(self,type):
        ...
        if type=='축구':
            ...
            self.btselect.setStyleSheet('background-image : url(image/풋살.png);')
        elif type=='농구':
            self.btselect.setStyleSheet('background-image : url(image/농구.png);')
        elif type=='족구':
            self.btselect.setStyleSheet('background-image : url(image/족구.png);')
    def detail(self):
        self.setVisible(False)
